...
<div class="flex flex-col modern-scrollbar overflow-y-auto p-6">
    ...
    <div class="w-full mx-auto mb-6 bg-gray-100 rounded-lg overflow-hidden">
        <iframe
            ...
            width="100%"
            height="100%"
            src="https://embed.figma.com/proto/T43AORXB22cDsJSkTzI0Fv/P2---Vedndor-Vista?node-id=1-463&viewport=471%2C567%2C0.36&scaling=contain&content-scaling=responsive&page-id=0%3A1&embed-host=share&hide-ui=1"
            allowfullscreen
        ></iframe>
    </div>
    <div class="w-full mx-auto mb-6 bg-gray-100 rounded-lg overflow-hidden">
