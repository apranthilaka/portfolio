...
<div class="flex flex-col h-screen modern-scrollbar overflow-y-auto">
    <div>Project Info</div>

    <div
        class="min-h-screen w-full h-full flex justify-center items-center relative"
    >
    ...
    <div class="card-container-1 px-6 pt-6 gap-6 min-h-screen">
        <!-- card one  -->
        <div
