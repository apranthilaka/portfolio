...
<div class="left-menu border-r border-gray-200 w-[230px] flex flex-col">
    <div
        class=" px-4 border-b border-gray-200 min-h-14 flex items-center justify-between"
    >
        <a
            href="/"
                ...
                <li>
                    <a
                        class={[
                            ...
                            {
                                'bg-gray-100 text-gray-950 font-medium  dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600 ':
                                    page.url.pathname + page.url.search ===
                                    menu.path,
                            },
                        ]}
